...
const schedule = [
  ...
  { time: "11:30 – 12:00 PM", topic: "Monogenic diabetes in Hall A", faculty: "Dr. V. Mohan" },
  { time: "12:00 – 12:30 PM", topic: "Prevention of Diabetes in India in Hall A", faculty: "Dr. A. Ramachandran" },
  { time: "12:30 – 01:15 PM", topic: "Prof. MV Gold Medal Oration 2026 & Launch (if any) in Hall A", faculty: "" },
...
export default function DaythreeHallB({ searchQuery }: { searchQuery: string }) {
