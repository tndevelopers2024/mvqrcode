    ...
    <section className="bg-gray-50 py-10 w-full">
      <div className="container mx-auto py-14 px-6 lg:px-20 bg-gradient-to-tr from-blue-950 to-blue-700 rounded-2xl">
        <div className="text-center mb-12">
          {/* ✅ Fixed heading animation (words preserved) */}
          <motion.h2
        ...
        <div className="relative pl-8">
          ...
          {schedule.map((item, i) => (
            ...
            >
              {/* Dot */}
              <span className="absolute -left-[43px] flex items-center justify-center w-6 h-6 rounded-full bg-white text-blue-700 text-xs">
                <Clock size={14} />
              </span>

              {/* Time */}
              <div className="text-sm font-semibold text-blue-700 bg-white inline-block px-4 rounded-3xl mb-1">
                {item.time}
              </div>
