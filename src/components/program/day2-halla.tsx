...
const schedule = [
  { time: "09:30 – 10:00", topic: "TBD", faculty: "Dr. Sunil Gupta", chair: "Dr. A. Shanmugam" },
  { time: "10:00 – 10:30", topic: "TBD", faculty: "Dr. Chandrasekar (API)", chair: "Dr. Priya" },
  { time: "10:30 – 10:50", topic: "TBD", faculty: "Dr. Rajendran (Apollo)", chair: "Dr. Paneerselvam" },
  { time: "10:50 – 11:10", topic: "TBD", faculty: "Dr. G. Vijayakumar", chair: "Dr. Shunmugavelu" },
  { time: "11:10 – 11:30", topic: "TEA BREAK & VISIT TO THE STALLS / POSTER AREA", faculty: "", chair: "" },
  { time: "11:30 – 12:00", topic: "TBD", faculty: "Dr. Anuj Maheshwari", chair: "Dr. Dharmarajan" },
  { time: "12:00 – 12:30", topic: "TBD", faculty: "Dr. Bhavatharani", chair: "Dr. K. Shanmugam" },
  { time: "12:30 – 01:00", topic: "TBD", faculty: "Dr. Balaji K", chair: "Dr. Bhavatharani" },
  { time: "01:00 – 01:30", topic: "TBD", faculty: "Dr. Paneer Selvam", chair: "Dr. Shunmugavelu" },
  { time: "01:30 – 02:30", topic: "LUNCH & VISIT TO THE STALLS / POSTER AREA", faculty: "", chair: "" },
  ...
  { time: "02:50 – 03:00", topic: "MOBILITY Break (to specify therapy)", faculty: "", chair: "" },
  { time: "03:00 – 04:00", topic: "Surgical Demonstration (VIDEO) – Debridement, VAC & TCC Application", faculty: "Dr. Kumar / Dr. Senthil", chair: "" },
  ...
  { time: "05:00 – 05:30", topic: "PHARMA SLOT (Insulin symposium)", faculty: "", chair: "" },
  { time: "05:30 – 06:00", topic: "How to evaluate kidney function in diabetes? / Symposium", faculty: "Dr. Edwin Fernando", chair: "Dr. Janaka" },
  { time: "06:00 – 06:30", topic: "TBD", faculty: "Dr. Krishna Seshadri", chair: "Dr. Balaji K" },
  { time: "06:30 – 07:00", topic: "How to prevent Medico legal problems", faculty: "Dr. Viswanathan Vishnu Vijay", chair: "Dr. Muralidharan, Dr. Prashanth Arun" },
  { time: "07:00 onwards", topic: "Networking Dinner", faculty: "", chair: "" },
];
    ...
    {word.split("").map((char, ci) => (
      ...
      >
        {char}
          ...
          <p className="text-gray-200">Scientific program for Hall A</p>
        </div>
