...
const faculty = [
  ...
  { name: "DR.LAKSHMANAN", img: "/images/faculty/s-s-lakshmanan.jpg" },
  ...
  { name: "Srikar Nallan", img: "/images/faculty/Srikar-nallan.jpg" },  
